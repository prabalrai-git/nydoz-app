...
const AddInformationChannel = (props) => {
    const { show, handleClose, setFetchAgain, selectedData } = props;
    const { postData, updateData, errList, error, isLoading } = useMutation(API_ROUTE.CM_INFORMATION_CHANNEL, true);
