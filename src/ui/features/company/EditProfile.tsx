...
const EditProfile = () => {
  ...
  return (
    <div className="tw-mx-5">
      <CompanyBreadcrumb
        title={
          location?.state?.data?.id ? "Edit Profile Details" : "Create Company"
        }
        btnText="Back"
        showBreadcrumb={true}
      />
                ...
                <div className="card-body  pt-0">
                  ...
                  >
                    <div className="d-flex justify-content-around align-items-center mb-6">
                      {location?.state?.data && (
                        <div className="image-input-wrapper w-100px h-100px p-2">
                          {oldThumbnil ? (
                            <img
                              className={
                                thumbnilImg && thumbnilImg?.length > 0
                      ...
                      {!location?.state?.data && thumbnilImg?.length === 0 && (
                        <div className="image-input-wrapper w-100px h-100px p-2">
                          <img
                            className="img-fluid rounded"
                            src={Images.BlackImg}
                ...
                <div className="card-body  pt-0">
                  ...
                  >
                    <div className="d-flex justify-content-around align-items-center gap-6 mb-6">
                      ...
                      {!location?.state?.data && coverImg?.length === 0 && (
                        <div
              ...
              <div className="card-body pt-0">
                <div className="row">
                  ...
                  <div className="col-12 col-md-6 gap-5 gap-md-7 mb-6">
                    <div className="fv-row flex-row-fluid fv-plugins-icon-container">
                      <label className="required form-label">Website</label>
                      <input
                        className="form-control"
                        {...register("website")}
            ...
            <div className="d-flex justify-content-end my-6 mb-6">
              ...
              >
                {isLoading ? (
                  ...
                  <span>{location?.state?.data?.id ? "Update" : "Submit"}</span>
                )}
              </button>
            </div>
          </div>
