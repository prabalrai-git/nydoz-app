                ...
                <NavDropdown title="Account" id="basic-nav-dropdown">
                  <NavDropdown.Item>
                    <div
                      ...
                      onClick={handleNavigateCreateCompany}
                    >
                      <span>
                        <BuildingAdd size={16} color="#ffffff" />
                      </span>
                      <span className="ms-3">Create Company</span>
                    </div>
                  </NavDropdown.Item>
                  <NavDropdown.Item>
                    {" "}
                  ...
                  <NavDropdown.Item>
                    <LinkContainer className="py-1" to="change-password">
                      <div>
                        <span className="me-3">
