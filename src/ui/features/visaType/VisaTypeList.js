...
const VisaTypeList = () => {
    ...
    const tableColumns = [
        ...
        {
            accessorKey: "name",
            header: () => (_jsx("div", { children: _jsx("span", { children: "Visa Type" }) })),
            cell: (info) => {
