...
const AddClient = () => {
  ...
  return (
    <div>
      <CompanyBreadcrumb
        title={location?.state?.data?.id ? "Update Client" : "Add Client"}
        showBreadcrumb={true}
        btnText="Back"
      />
          ...
          <form className="form w-100 " onSubmit={onFormSubmit}>
            <div className="row">
              ...
              <div className="col-12 mb-3">
                <div>
                  <h3 className="fs-4 mb-5" id="custom-form-control">
                    Personal Details
                  </h3>
                </div>
                <div className="row">
              ...
              <div className="col-12 mb-6">
                <div>
                  <h2 className="fs-4 mb-5" id="custom-form-control">
                    Address Details
                  </h2>
                </div>
                <div className="row">
              ...
              <div className="col-12 mb-6">
                ...
                <div className="row">
                  ...
                  <div className="col-12 col-md-6 gap-5 gap-md-7 mb-6">
                    <div className="fv-row flex-row-fluid fv-plugins-icon-container">
                      <label className="required form-label">Deal Amount</label>
                      <input
                        className="form-control"
                        type="number"
                  ...
                  <div className="col-12 col-md-6 gap-5 gap-md-7 mb-6">
                    <div className="fv-row flex-row-fluid fv-plugins-icon-container">
                      ...
                      <AsyncSelect
                        ...
                        setSelectValue={setSelectCurrencyCode}
                        selectValue={selectedCurrencyCode}
                        dataId="code"
                        showDataLabel="name"
                      />
                    </div>
                  ...
                  <div className="col-12 col-md-6 gap-5 gap-md-7 mb-6">
                    <div className="fv-row flex-row-fluid fv-plugins-icon-container">
                      <label className="form-label">Enrollment Openings:</label>
