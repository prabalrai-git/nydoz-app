...
const AddDocuments = (props) => {
    ...
    const { postData, error, isLoading, updateData } = useMutation(`${API_ROUTE.POST_DOCUMENTS_BY_COMPANY_ID}/${companyId}/documents`, true);
    useEffect(() => {
        if (selectedData) {
